...
import { Home as HomeIcon, Brain, Rocket, User } from 'lucide-react';
import './HomeNew.css';
...
const HomeNew = () => {
  ...
  // Product cards SURROUNDING BrandsXAI from all sides
  const productCards = [
    // TOP LEFT AREA
    {
      id: 1,
    ...
    <div className="home-new-container">
      ...
      <div className="main-card-container">
        ...
        <div className="top-banner">
          <div className="banner-content">
            ...
            <span>Download BrandsXAI app. Available on iOS & Android</span>
        ...
        <div className="hero-wrapper">
          ...
          <div className="hero-center">
            <h1 className="hero-main-title">BrandsXAI</h1>
        ...
        <div className="metrics-container">
          <div className="metrics-left">
            <h2 className="metrics-heading">
              Millions trust BrandsXAI<br />to deliver great value
            </h2>
          </div>
      ...
      <section className="case-studies-section">
        <div className="case-studies-container">
          <h2 className="case-studies-heading">Supercharge your<br/>business with <span className="highlight-purple">BrandsXAI</span></h2>
